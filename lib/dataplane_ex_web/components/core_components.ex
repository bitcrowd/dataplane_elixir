defmodule DataplaneExWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    #   Gettext.dngettext(DataplaneExWeb.Gettext, "errors", msg, msg, count, opts)
    # else
    #   Gettext.dgettext(DataplaneExWeb.Gettext, "errors", msg, opts)
    # end
